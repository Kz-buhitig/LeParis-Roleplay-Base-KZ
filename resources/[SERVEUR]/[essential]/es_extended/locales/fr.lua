Locales['fr'] = {
  ...
  ['received_salary'] = 'Une prime provenant de ~o~L\'état~s~ et d\'un montant de ~g~€%s~s~ vous à été versé.',

  ['received_salary2'] = 'Un virement ~o~annonyme~s~ d\'un montant de ~g~€%s~s~ vous à été versé.',

  ['received_help'] = '~o~L\'état~s~ vous à versé votre RSA d\'un montant de ~g~€%s~s~',
  ...
  ['received_paycheck'] = 'Virement entrant',

  ['received_paycheck2'] = 'Virement entrant',
