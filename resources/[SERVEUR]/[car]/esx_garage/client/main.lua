...
function SpawnVehicle(vehicleProps, garage, KindOfVehicle)
	ESX.Game.SpawnVehicle(vehicleProps.model, {
		...
		z = garage.SpawnPoint.Pos.z + 1											
			...
			if KindOfVehicle == 'brewer' or KindOfVehicle == 'biker' or KindOfVehicle == 'jewelry' or KindOfVehicle == 'farmer' or KindOfVehicle == 'fisherman' or KindOfVehicle == 'Config.Price' or KindOfVehicle == 'johnson' or KindOfVehicle == 'miner' or KindOfVehicle == 'reporter' or KindOfVehicle == 'winemakers' or KindOfVehicle == 'tobacco' then
