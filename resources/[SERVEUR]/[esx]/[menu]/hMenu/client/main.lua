print("^0======================================================================^7")
print("^0[^4Author^0] ^7:^0 ^0KRZ edited by KZ for Horizon^7")
...
function RenderWalletMenu()
	RageUI.DrawContent({header = true, instructionalButton = true}, function()
		...
		RageUI.Button(_U('wallet_give_car_key'), nil, {}, true, function(Hovered, Active, Selected)
			if (Selected) then
...
function RenderBoss2Menu()
	RageUI.DrawContent({header = true, instructionalButton = true}, function()
		if societymoney ~= nil then
			RageUI.Button(_U('bossmanagement_chest_button'), nil, {RightLabel = '€' .. societymoney2}, true, function() end)
		end
