...
function ToggleDoor()
	...
	local secretCode = KeyboardInput("Entrer le code :", "", 4)
	...
	for i=1, #Config.DoorList do
		...
		if distance < maxDistance then
			...
			if tonumber(secretCode) == nil then
				ESX.ShowNotification("~y~Veuillez entrer un code valide.")
				return false
			end
