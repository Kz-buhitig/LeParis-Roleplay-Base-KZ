...
Config.NPCJobEarnings             = { min = 50, max = 150 }
Config.Locale = 'fr'
...
Config.Zones = {
	...
	MecanoActions = {
		Pos   = { x = 1018.208, y = -2290.673, z = 29.700},
	...
	Garage = {
		Pos   = { x = 1007.82, y = 2328.091, z = 30.51},
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1,
	},
	...
	Craft = {
		Pos   = { x = 1012.1, y = -2336.669, z = 29.71},
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 25,
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = 990.553, y = -2326.574, z = 30.51},
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
	},

	VehicleDeleter = {
		Pos   = { x = 992.794, y = -2343.885, z = 30.51 },
	...
	VehicleDelivery = {
		Pos   = { x = 996.432, y = -2312.863, z = 29.71},
