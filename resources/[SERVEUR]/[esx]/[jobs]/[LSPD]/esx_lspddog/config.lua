...
Config = {
    ...
    Drugs = {'weed', 'opium', 'coke', 'meth', 'bagofdope', 'coke_pooch', 'meth_pooch', 'crack_pooch', 'weed_pooch', 'opium_pooch'}, -- add all drugs here for the dog to detect
