...
Config.CarZones = {
	...
	PoliceCarGarage = {
		...
		Pos = {
			...
			{x = -1047.156, y = -851.789, z = 4.868},

			{x = -1117.102, y = -855.358, z = 13.501}
...
Config.ExtraDraw3DText = "[E] Pour Ouvrir Le Menu Custom"		-- set your desired text here
...
Config.LabelPrimaryCol = "Couleur Primaire"
...
Config.TitleColorType = "Couleur"

Config.TitleValues = "Valeur"
...
Config.NoVehicleNearby = "Véhicule non détecté !"

Config.CarOutFromPolGar = "Vous avez pris un ~b~Vehicle~s~ du ~y~Garage de Police~s~!"

Config.HeliOutFromPolGar = "Vous avez pris un ~b~Helicopter~s~ de ~y~L'Héliport de Police~s~!"

Config.BoatOutFromPolGar = "Vous avez pris un ~b~Bateau~s~ de ~y~La Marina de Police~s~!"
...
Config.Progress1 = "REPARATION EN COURS"

Config.Progress2 = "LUSTRAGE EN COURS"
...
Config.VehicleLoadText = "Chargement du véhicule"			-- text on screen when vehicle model is being loaded
...
Config.ExtraZones = {
	...
	ExtraPositions = {
		...
		Pos = {
			...
			{x = -1050.838, y = -867.263, z = 5.132},

			{x = -1130.193, y = -839.89, z = 13.663}
