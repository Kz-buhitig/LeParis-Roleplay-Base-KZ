...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{ label = 'Tenue Officier', value = 'officer_wear' },
		{ label = 'Tenue Sergent', value = 'sergeant_wear'},
...
RegisterNetEvent('esx_policejob:fouiller')
AddEventHandler('esx_policejob:fouiller', function()
	OpenBodySearchMenu(closestPlayer)
end)
...
AddEventHandler('police:InfoService', function(service, prenom, nom)
	if service == 'prise' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('POLICE | INFORMATIONS', '~b~Prise de service', 'Agent: ~g~'..prenom.. ' ' ..nom..'\n~w~Code: ~g~10-8\n~w~Information: ~g~Prise de service.', 'CHAR_CALL911', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'fin' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('POLICE | INFORMATIONS', '~b~Fin de service', 'Agent: ~g~'..prenom.. ' ' ..nom..'\n~w~Code: ~g~10-10\n~w~Information: ~g~Fin de service.', 'CHAR_CALL911', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'pause' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('POLICE | INFORMATIONS', '~b~Pause de service', 'Agent: ~g~'..prenom.. ' ' ..nom..'\n~w~Code: ~g~10-6\n~w~Information: ~g~Pause de service.', 'CHAR_CALL911', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'standby' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('POLICE | INFORMATIONS', '~b~Mise en standby', 'Agent: ~g~'..prenom.. ' ' ..nom..'\n~w~Code: ~g~10-12\n~w~Information: ~g~Standby, en attente de dispatch.', 'CHAR_CALL911', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'control' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('POLICE | INFORMATIONS', '~b~Control routier', 'Agent: ~g~'..prenom.. ' ' ..nom..'\n~w~Code: ~g~10-48\n~w~Information: ~g~Control routier en cours.', 'CHAR_CALL911', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'refus' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('POLICE | INFORMATIONS', '~b~Refus d\'obtempérer', 'Agent: ~g~'..prenom.. ' ' ..nom..'\n~w~Code: ~g~10-30\n~w~Information: ~g~Refus d\'obtempérer / Délit de fuite en cours.', 'CHAR_CALL911', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'arrestation' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('POLICE | INFORMATIONS', '~b~Arrestation en cours', 'Agent: ~g~'..prenom.. ' ' ..nom..'\n~w~Code: ~g~10-31\n~w~Information: ~g~Arrestation en cours.', 'CHAR_CALL911', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	end
end)
