...
Config.ArmyDatabaseName = 'army'	-- set the exact name from your jobs database for police
...
-- Army Heli Garage Blip Settings:
...
-- Army Boat Garage Blip Settings:
...
-- Army Car Garage Marker Settings:

Config.ArmyCarMarker = 27 												-- marker type

Config.ArmyCarMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 			-- rgba color of the marker

Config.ArmyCarMarkerScale = { x = 1.5, y = 1.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis

Config.CarDraw3DText = "[E] Pour Ouvrir Le Garage"			-- set your desired text here



-- Army Heli Garage Marker Settings:

Config.ArmyHeliMarker = 27 												-- marker type

Config.ArmyHeliMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker

Config.ArmyHeliMarkerScale = { x = 5.5, y = 5.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis

Config.HeliDraw3DText = "[E] Pour Ouvrir Le Garage"		-- set your desired text here



-- Army Boat Garage Marker Settings:

Config.ArmyBoatMarker = 27 												-- marker type

Config.ArmyBoatMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker

Config.ArmyBoatMarkerScale = { x = 3.0, y = 3.0, z = 1.0 }  				-- the scale for the marker on the x, y and z axis

Config.BoatDraw3DText = "[E] Pour Ouvrir Le Garage"		-- set your desired text here



-- Army Extra Garage Marker Settings:

Config.ArmyExtraMarker = 27 												-- marker type

Config.ArmyExtraMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker

Config.ArmyExtraMarkerScale = { x = 2.5, y = 2.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis

Config.ExtraDraw3DText = "Press ~g~[E]~s~ for ~y~Army Extra Menu~s~"		-- set your desired text here
...
Config.ArmyVehicles = {
        ...
        { model = 'newvic', label = 'Cruiser Cadet LSPD'},

		{ model = '18charger', label = 'Dodge LSPD'},

		{ model = '16explorer', label = 'Ford Interceptor LSPD'},

        { model = '16taurus', label = 'Taurus LSPD'},

		{ model = 'ghispo2', label = 'Maseratti LSPD'},

		{ model = '11caprice', label = 'Chevrolet LSPD'},

        { model = '18tahoe', label = 'Tahoe LSPD'},
		...
		{ model = 'pbus', label = 'Army Prison Bus'},
...
Config.ArmyHelicopters = {

	{ model = 'as350', label = 'Helicoptere', livery = 0, price = 0 },
        { model = 'polmav', label = 'Helicoptere Nuit', livery = 0, price = 0 }
...
Config.ArmyBoats = {
	...
	{ model = 'predator', label = 'Army Predator', livery = 0, price = 0 },
...
Config.TitleArmyGarage = "Army Garage"

Config.TitleArmyExtra = "Extra"

Config.TitleArmyLivery = "Livery"
...
Config.CarOutFromPolGar = "You took out a ~b~Vehicle~s~ from ~y~Army Garage~s~!"

Config.HeliOutFromPolGar = "You took out a ~b~Helicopter~s~ from ~y~Army Heli Garage~s~!"

Config.BoatOutFromPolGar = "You took out a ~b~Boat~s~ from ~y~Army Boat Garage~s~!"
