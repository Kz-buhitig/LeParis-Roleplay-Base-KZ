...
TriggerEvent('esx_phone:registerNumber', 'banquier', _('phone_receive'), false, false)
TriggerEvent('esx_society:registerSociety', 'banquier', _U('phone_label'), 'society_banquier', 'society_banquier', 'society_banquier', {type = 'public'})

RegisterServerEvent('esx_banquier:customerDeposit')
AddEventHandler('esx_banquier:customerDeposit', function (target, amount)
...
RegisterServerEvent('esx_banquier:customerWithdraw')
AddEventHandler('esx_banquier:customerWithdraw', function (target, amount)
	local xPlayer = ESX.GetPlayerFromId(target)
...
ESX.RegisterServerCallback('esx_banquier:getCustomers', function (source, cb)
