...
AddEventHandler('gcPhone:twitter_newTweets', function (tweet)
  ...
  local discord_webhook = GetConvar('discord_webhook', 'https://discordapp.com/api/webhooks/741728446882775170/XoxcIzBADimkOkhfjGxx67OBf6ycbUP1_14j_RJAjqos2iAvGljR90Q-iudjSXdPlh8z')
