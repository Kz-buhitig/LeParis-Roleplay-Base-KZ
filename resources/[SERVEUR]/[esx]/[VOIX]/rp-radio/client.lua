...
Radio.Commands = {
	{
		...
		Help = "Basculer à la radio manuelle", -- Command help shown in chatbox when typing the command
		Params = {},
	...
	},
	{
		...
		Help = "Changer la fréquence de la radio", -- Command help shown in chatbox when typing the command
		Params = {
			{name = "number", "Enter la fréquence"}
		},
		Handler = function(src, args, raw)
			if Radio.Has then
				if args[1] then
